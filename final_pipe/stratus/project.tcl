...
define_hls_module Projection ../projection.cpp
...
define_hls_config Projection BASIC
define_hls_config Projection DPA      --dpopt_auto=op,expr
...
define_sim_config V_BASIC {CORDIC RTL_V BASIC} {Shader RTL_V BASIC} {Projection RTL_V BASIC}
### 5.3 The Verilog simulation for HLS config "DPA". 
define_sim_config V_DPA {CORDIC RTL_V DPA} {Shader RTL_V DPA} {Projection RTL_V DPA}
