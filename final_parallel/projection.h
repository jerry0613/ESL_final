...
#ifndef NATIVE_SYSTEMC
    cynw_p2p< sc_int<16> >::in i_rox;
    cynw_p2p< sc_int<16> >::in i_roy;
    cynw_p2p< sc_int<16> >::in i_roz;

    cynw_p2p< sc_int<48> >::out o_result;
#else
    sc_fifo_in<sc_int<16>> i_rox;
    sc_fifo_in<sc_int<16>> i_roy;
    sc_fifo_in<sc_int<16>> i_roz;
