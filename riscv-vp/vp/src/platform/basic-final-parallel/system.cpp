  ...
  case tlm::TLM_WRITE_COMMAND:
    switch (addr) {
		...
		case R_ADDR:
			...
			break;
		case T_ADDR:
			cordic.i_T.write((data_ptr[1] << 8) + data_ptr[0]);
			break;
		case IN_X_ADDR:
			shader.i_x1.write((data_ptr[1] << 8) + data_ptr[0]);
			shader.i_x2.write((data_ptr[1] << 8) + data_ptr[0]);
			shader.i_x3.write((data_ptr[1] << 8) + data_ptr[0]);
			break;
		case IN_Y_ADDR:
			shader.i_y1.write((data_ptr[1] << 8) + data_ptr[0]);
			shader.i_y2.write((data_ptr[1] << 8) + data_ptr[0]);
			shader.i_y3.write((data_ptr[1] << 8) + data_ptr[0]);
			break;
		case IN_Z_ADDR:
			shader.i_z1.write((data_ptr[1] << 8) + data_ptr[0]);
			shader.i_z2.write((data_ptr[1] << 8) + data_ptr[0]);
			shader.i_z3.write((data_ptr[1] << 8) + data_ptr[0]);
			break;
		default:
		break;
    }
