...
public:
	...
	addr_t system0_start_addr = 0x73000000;
 	addr_t system0_size = 0x01000000;
 	addr_t system0_end_addr = system0_start_addr + system0_size - 1;
	addr_t system1_start_addr = 0x74000000;
 	addr_t system1_size = 0x01000000;
 	addr_t system1_end_addr = system1_start_addr + system1_size - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > system1_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[12] = new PortMapping(opt.system0_start_addr, opt.system0_end_addr);
	bus.ports[13] = new PortMapping(opt.system1_start_addr, opt.system1_end_addr);
	...
	bus.isocks[12].bind(System0.tsock);
	bus.isocks[13].bind(System1.tsock);
